// ColorPickerActivity відповідає за відображення та взаємодію з інтерфейсом для вибору кольору.
// Його основна функція — надати користувачеві можливість обрати певний колір, а потім повернути цей вибір назад до MainActivity .
...
import com.beemaster.beekeeperjournal.adapters.ColorGridAdapter
